...
public class DatabaseProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case BOOK_ITEM:
                ...
                deleteRows = database.delete("Book", "id = ?", new String[]{
                        bookId
                });
                break;
            case CATEGORY_DIR:
            ...
            case CATEGORY_ITEM:
                ...
                deleteRows = database.delete("Category", "id = ?", new String[]{
                        categoryId
                });
                break;
            default:
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case BOOK_ITEM:
                String bookId = uri.getPathSegments().get(1);
                updatedRows = database.update("Book", values, "id = ?", new String[]{
                        bookId
                });
                break;
            case CATEGORY_DIR:
            ...
            case CATEGORY_ITEM:
                String categoryId = uri.getPathSegments().get(1);
                updatedRows = database.update("Category", values, "id = ?", new String[]{
                        categoryId
                });
            default:
                break;
